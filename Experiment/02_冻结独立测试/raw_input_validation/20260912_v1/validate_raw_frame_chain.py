...
def main():
    ...
    result = {"status":"SAMPLED_INTERNAL_FRAME_PARITY_PASS" if exact_frames==len(rows) and pose_frames==len(rows) and roi_match==len(roi_rows) else "PARITY_REVIEW_REQUIRED",
